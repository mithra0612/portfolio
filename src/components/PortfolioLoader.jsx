  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // IMPORTANT: store bound resize handler so removeEventListener works
...
const PortfolioLoader = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(fadeOut, 2500);
    return () => clearTimeout(t);
  }, [onComplete]);

  return (
    <div ref={loaderRef} className="fixed inset-0 z-50" style={{ opacity: 1 }}>
      {/* Background */}
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div
          className="text-white text-3xl sm:text-5xl tracking-[0.5em] select-none"
          style={{
            fontFamily: "'Orbitron','Space Grotesk','JetBrains Mono',monospace",
