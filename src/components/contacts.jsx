...
import { Mail, Linkedin, Github, Copy, Clock, MapPin, CheckCircle, ExternalLink } from "lucide-react";
    ...
    <section className="bg-black text-white py-12 sm:py-16 md:py-24 overflow-hidden">
      <div className="max-w-6xl mx-auto px-2 sm:px-4 md:px-6 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-20">
          {/* Left Side */}
          <div>
            <h2 className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-black mb-6 sm:mb-8 leading-tight text-white">
              Let's work
              <br />
              <span className="text-blue-500">together</span>
            </h2>
            <p className="text-gray-400 text-lg sm:text-xl md:text-2xl font-bold leading-relaxed mb-8 sm:mb-10">
              ...
              <div>
                ...
                <div className="flex gap-6 sm:gap-8">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-500 hover:text-gray-700 transition-colors p-2 sm:p-1"
                    aria-label="GitHub"
                  >
          ...
          <div className="space-y-8 sm:space-y-10 w-full min-w-0">
            ...
            <div className="border border-gray-800 rounded-lg p-6 sm:p-7 hover:border-blue-500/30 transition-colors">
              ...
              <div className="space-y-4 sm:space-y-5">
                <div className="flex items-start gap-3">
                  <Clock size={24} className="text-blue-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <div className="font-black text-base sm:text-lg text-white">Response Time</div>
                    <div className="text-gray-400 text-base sm:text-lg font-semibold">Usually within 24 hours</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <MapPin size={24} className="text-blue-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <div className="font-black text-base sm:text-lg text-white">Timezone</div>
                    <div className="text-gray-400 text-base sm:text-lg font-semibold">Indian Standard Time (IST)</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border border-gray-800 rounded-lg p-6 sm:p-7 hover:border-green-500/30 transition-colors">
              ...
              <p className="text-gray-400 mb-5 text-base sm:text-lg font-bold">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 text-white font-black px-6 sm:px-8 py-4 rounded-md transition-colors text-base sm:text-lg w-full sm:w-auto"
              >
                Book a call
